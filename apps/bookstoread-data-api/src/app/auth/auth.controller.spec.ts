import { Token } from '@schoolproject/data';
  ...
  describe('register', () => {
    ...
    beforeEach(() => {
      ...
      create = jest
        ...
        .mockImplementation(async (_u: string) => {
          return exampleId;
        });
    });
    ...
    it('should call the register and create method of the auth service on success', async () => {
      register = jest
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        .mockImplementation(async (_u: string, _p: string) => {
          return;
        });
  ...
  describe('login', () => {
    it('should call the generateToken method of the auth service', async () => {
      ...
      const register = jest
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        .mockImplementation(async (_u: string, _p: string) => {
          return mockedToken.token;
        });

      expect(await authController.login(exampleUser)).toStrictEqual(
        mockedToken
      );
